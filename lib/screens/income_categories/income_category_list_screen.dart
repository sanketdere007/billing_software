...
import 'add_income_category_screen.dart';

class IncomeCategoryListScreen extends StatefulWidget {
  const IncomeCategoryListScreen({super.key});

  @override
  State<IncomeCategoryListScreen> createState() => _IncomeCategoryListScreenState();
}

class _IncomeCategoryListScreenState extends State<IncomeCategoryListScreen> {
  ...
  void _navigateToAdd() {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (context) => const AddIncomeCategoryScreen()),
    );
  }
            ...
            Padding(
              ...
              child: TextField(
                decoration: InputDecoration(
                  hintText: 'Search income categories...',
            ...
            body: Row(
              children: [
                ...
                Expanded(
                  child: Scaffold(
                    appBar: AppBar(
                      title: const Text('Income Category Master'),
                      actions: [
                        IconButton(
  ...
  Widget _buildListView(List<IncomeCategory> categories) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            leading: CircleAvatar(
              ...
              child: Icon(Icons.savings, color: Theme.of(context).colorScheme.onPrimaryContainer),
            ),
            title: Text(
              category.name,
  ...
  Widget _buildDataTable(List<IncomeCategory> categories) {
