class ApiConstants {
  ...
  static const String insertOrUpdateBatchEndpoint = '/api/Batch/InsertOrUpdateBatch';
  static const String getAllProductStockEndpoint = '/api/Batch/GetAllProductStock';
